...
export const deathMessagesByTheme = {
  ...
  "harry-potter": [
    ...
    "was transfigured into something that couldn't survive",
    ...
    "was lost to Devil's Snare",
    "was struck down by Bellatrix Lestrange",
    "fell victim to an Unforgivable Curse",
    "was snatched by a flying Death Eater",
    "died defending the castle",
    "was lost to the Dark Lord's wrath",
    "was trapped by a powerful enchantment",
    "was overwhelmed by Inferi in dark waters",
  ],
